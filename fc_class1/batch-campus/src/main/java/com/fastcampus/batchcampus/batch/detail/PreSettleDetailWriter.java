...
public class PreSettleDetailWriter implements ItemWriter<Key>, StepExecutionListener {
    ...
    public void beforeStep(StepExecution stepExecution) {
        ...
        final ConcurrentMap<Key, Long> snapshotMap = new ConcurrentHashMap<>(); // Key와 count가 들어감
        stepExecution.getExecutionContext().put("snapshots", snapshotMap); // stepExecution 안에 snapshotMap을 할당함
    }
}
